...
<div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action="userExchangeControl.php" method="POST">
                ...
                <input type="text" name="search" placeholder="Enter Value To Search" id="search" style="float: right;" /><br><br>
                                <div class="dataTable_wrapper">
                                    <?php                             
                                        ...
                                        <form name='form2' method='post' action='userExchangeControl.php'>
                                        <tr><th>Request Date</th><th>Your Product Name</th><th>Your Product Image</th><th>Exchanger Name</th><th>Exchanger Product Name</th><th>Exchanger Product Image</th><th>Exchanger Address</th><th>Status</th><th>Operation</th></tr>";
                                        while($row = mysqli_fetch_array($result)) {
                                            ...
                                            <td>
                                            <button><a href='userExchangeControl.php?cancel=".$row["exchange_id"]."' Onclick='return ConfirmCancel()'>Cancel</a>"."</button>
                                            </td></tr>";
                                        }
                                        echo "</table>";
