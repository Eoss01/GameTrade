...
<div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action="userRentControl.php" method="POST">
                ...
                <input type="text" name="search" placeholder="Enter Value To Search" id="search" style="float: right;" /><br><br>
                                <div class="dataTable_wrapper">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        <form name='form' method='post' action='userRentControl.php'>
                                        <tr><th>Request Date</th><th>Renter Name</th><th>Product Name</th><th>Quantity</th><th>Rent Price</th><th>Start Date</th><th>End Date</th><th>Status</th><th>Operation</th></tr>";
                                        while($row = mysqli_fetch_array($result)) {
                                            ...
                                            <td>
                                            <button><a href='userRentControl.php?cancel=".$row["rent_id"]."' Onclick='return ConfirmCancel()'>Cancel</a>"."</button>
                                            </td></tr>";
                                        }
                                        echo "</table>";
